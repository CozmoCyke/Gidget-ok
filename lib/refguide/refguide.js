...
function getLocalReferenceEntry(word) {
	...
	var entries = {
		...
		done: { title: "done", summary: "Marks an action, task, or state as finished." },
		...
		energy: { title: "energy", summary: "Shows how much energy Gidget has left to finish the level." },
		ensure: { title: "ensure", summary: "Keep checking that the condition stays true while the robot works." },
		for: { title: "for", summary: "Starts a loop that visits each item in a list one by one." },
		function: { title: "function", summary: "Defines a reusable action the robot can call again." },
		...
		in: { title: "in", summary: "Connects the loop variable to the list the robot will walk through." },
		list: { title: "list", summary: "A collection of objects or values the robot can loop over." },
		...
		position: { title: "position", summary: "Shows where the robot or an object is in the level." },
		property: { title: "property", summary: "A detail the robot can read, such as color, name, or status." },
		return: { title: "return", summary: "Makes a function send back a value or result the robot can use again." },
		...
		set: { title: "set", summary: "Assigns a value so the robot can remember it or change a property." },
