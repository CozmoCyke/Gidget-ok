...
function getLocalReferenceEntry(word) {
	...
	var entries = {
		...
		drop: { title: "drop", summary: "Stops grabbing an object." },
		...
		goto: { title: "goto", summary: "Moves Gidget toward a target object." },
		grab: { title: "grab", summary: "Lets Gidget carry an object." },
		if: { title: "if", summary: "Executes only when a condition is true." },
		...
		list: { title: "list", summary: "A collection of objects or values." },
		...
		this: { title: "this", summary: "Refers to the current object." },
	...
	return {
		title: key || "help",
		summary: "No local reference entry is available for this term."
	};
}
